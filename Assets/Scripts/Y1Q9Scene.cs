...
/// <summary>
/// Script for game logics of task 9.
/// </summary>
public class Y1Q9Scene : MonoBehaviour {
	...
	void Start () {
		...
		AppManager.Instance.setCurrentTaskYearAndNumber (1, 9);
	}
	...
	/// <summary>
	/// Draws the hint which are two dotted lines postioned at the beginning and the end.
	/// </summary>
